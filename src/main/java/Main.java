 ...
 *
 * <p>
 * Its sole responsibility is to instantiate the primary controller class
...
public class Main {
     ...
     *
     * <p>
     * This method schedules the creation and execution of the application on
     * the AWT Event Dispatch Thread (EDT) to ensure thread-safety for all
     * Swing components, which is a required practice.
     * </p>
     *
