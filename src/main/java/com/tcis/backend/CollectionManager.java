 ...
 *
 * <p>This class acts as the single source of truth for the player's entire card
 * pool, handling the core logic of card creation and inventory counts. All
 * card name lookups are case-insensitive.</p>
 */
public class CollectionManager {
     ...
     *
     * <p>This method is the primary entry point for introducing a new card into
     ...
     *         otherwise.
     */
    public boolean addNewCard(String name, double baseValue, Rarity rarity,
                              Variant variant) {
     ...
     *
     * <p>Fails if the card doesn't exist, the amount is not positive, or if it
     * would result in a negative count.</p>
     *
     * @param name The name of the card.
     ...
     *
     * <p>This is a specialized convenience method that calls
     * {@code decreaseCount(cardName, 1)}.</p>
     *
