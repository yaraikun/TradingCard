 ...
 * creation of invalid card objects, acting as the final gatekeeper for data integrity.
 */
public class Card {
    /**
    ...
    /**
     * The base dollar value of the card before any variant multipliers are applied.
     * This field is final to ensure it is immutable after creation.
     */
    ...
    /**
     * Calculates the card's real value by applying the variant's multiplier to the base value.
     * This is used for selling cards and calculating binder/deck prices.
